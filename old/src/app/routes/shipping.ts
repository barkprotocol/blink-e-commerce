...
import * as MetaplexService from "../services/metaplex";
...
router.get("/", (req, res) => {
  try {
    const responseBody: ActionGetResponse = {
      ...
      type: "action",
      title: "BarkShop Shipping Autofill",
      description:
        "Create and mint an encrypted NFT of your shipping info. You can later use this NFT to auto-fill your shipping info and checkout in one click in any BARK e-commerce blink.",
      links: {
        actions: [
          {
