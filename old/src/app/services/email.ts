...
class EmailService {
  ...
  async sendEmail(to: string, subject: string, html: string): Promise<void> {
    ...
    const mailOptions = {
      from: process.env.EMAIL_FROM || "BarkShopofficial@gmail.com",
      to,
      subject,
      html,
    };
  ...
  async sendVerificationEmail(
    ...
    const subject = "BarkShop Product Creation Verification";
    const html = `
      <h1>BarkShop Product Creation Verification</h1>
